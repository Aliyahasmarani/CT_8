...
<div class="container" style="margin-top: 5rem;">
    <h2>DATA CHECKLIST <i class="fas fa-clipboard-list"></i></h2>
    <hr>



    <button type="button" class="btn  btn-primary mb-1" data-bs-toggle="modal" data-bs-target="#modalTambah"> <i class="fas fa-plus-circle"></i> Tambah Data</button> <br><br>
    ...
    <div class="keterangan">
        <h6>KETERANGAN :</h6>
        <ul>
            <li><small>Kloset, Wastafel, Lantai, Dinding, dan Kaca (1: Bersih, 2: Kotor, 3: Rusak)</small></li>
            <li><small>Sabun (1: Ada, 2: Habis, 3: Hilang)</small></li>
            <li><small>Bau (1: Ya, 2: Tidak)</small></li>
        </ul>
    </div>
</div>
    ...
    <div class="modal fade" id="modalHapus<?= $checklist['id_checklist']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Yakin Anda Ingin Menghapus Data checklist Tersebut ?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Kembali</button>
                    <a href="hapus_check.php?id_checklist=<?= $checklist['id_checklist']; ?>" class="btn btn-danger">Hapus</a>
                </div>
                </form>
            </div>
        </div>
