...
<div class="container" style="margin-top: 5rem;">
    <h2>DATA USERS <i class="fas fa-users"></i></h2>
    <hr>
    ...
    <div class="keterangan">
        <h6>KETERANGAN :</h6>
        <ul>
            <li><small>Status (1: Aktif, 2: Non-aktif)</small></li>
            <li><small>Role (1: Admin, 2: User)</small></li>
        </ul>
    </div>
</div>
    ...
    <div class="modal fade" id="modalHapus<?= $users['id_users']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Kembali</button>
                    <a href="hapus_user.php?id_users=<?= $users['id_users']; ?>" class="btn btn-danger">Hapus</a>
                </div>
                </form>
            </div>
        </div>
